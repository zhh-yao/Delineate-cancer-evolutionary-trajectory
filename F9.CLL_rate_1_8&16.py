...
def proPlot(p1, p8, p16):
    ...
    x1 = np.arange(0, len(p1[0]), 1)
    ax.fill_between(x1, p1[1], p1[2], alpha=0.3)
    ax.plot(x1, p1[0], lw=5, label='Patient %d'%1)      
    
    x8 = np.arange(0, len(p8[0]), 1)
    ax.fill_between(x8, p8[1], p8[2], alpha=0.3)
    ax.plot(x8, p8[0], lw=5, label='Patient %d'%8)      
    
    x16 = np.arange(0, len(p16[0]), 1)
    ax.fill_between(x16, p16[1], p16[2], alpha=0.3)
    ax.plot(x16, p16[0], lw=5, label='Patient %d'%16)      
    ...
    plt.savefig('Proliferation.eps', bbox_inches='tight')
...
##Patient 1
Patient = 1
prolifMat1 = prolifCombine(Patient, keys, 10)
p1 = rateMCI(prolifMat1)
##Patient 8
Patient = 8
prolifMat8 = prolifCombine(Patient, keys, 10)
p8 = rateMCI(prolifMat8)
##Patient 16
Patient = 16
prolifMat16 = prolifCombine(Patient, keys, 10)
