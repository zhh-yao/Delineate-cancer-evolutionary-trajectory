...
def plot(data, allcycle):
    ...
    for i in range(n-1):
        ...
        axs[i].set_ylim(-20000000000, 20000000000)
    ...
    axs[n-1].set_ylim(-20000000000, 20000000000)
...
dataE = []
for i in range(10):
    temp = dataImport('Exponential', i, keys)
    temp[temp < 1] = 0
...
dataL = []
for i in range(10):
    temp = dataImport('Logistic', i, keys)
