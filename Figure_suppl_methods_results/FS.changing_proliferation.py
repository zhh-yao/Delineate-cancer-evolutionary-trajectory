...
def prolifPlot(dataE, dataL, dataH):
    ...
    ax.set_ylabel('Rate of Proliferation', font1, labelpad=20)
    ...
    plt.savefig('prolif_0_3000.tif', bbox_inches='tight')
    plt.savefig('prolif_0_3000.eps', bbox_inches='tight')
...
meanP_E = meanProlif('Exponential', 200, allclones, 3000)
meanP_L = meanProlif('Logistic', 200, allclones, 3000)
meanP_H = meanProlif('Hill', 200, allclones, 3000)
