...
def plot(Patient, data, allcycle):
    ...
    for i in range(n-1):
        ...
        axs[i].set_ylim(-2000000000, 2000000000)
    ...
    axs[n-1].set_ylim(-2000000000, 2000000000)
