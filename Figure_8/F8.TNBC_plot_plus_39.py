...
def plot(Patient, data, allcycle):
    ...
    for i in range(n-1):
        ...
        axs[i].set_ylim(-400000000000, 400000000000)
    ...
    axs[n-1].set_ylim(-400000000000, 400000000000)
