...
number_39 = number_estimation(9.5)
t = 2000
# calculate possible grawth
Para1 = [0.01, 0.008]
Para2 = [0.01, 8000000000000, 0.008]
Para3 = [0.01, 1, 0.0000000000005, 0.008]

growth1 = CellNumber(t, Exponential, Para1, number_39)[:,0]
growth2 = CellNumber(t, Logistic, Para2, number_39)[:,0]
growth3 = CellNumber(t, Hill, Para3, number_39)[:,0]
hypothesis_Plot('039', growth1, growth2, growth3)
...
agentMat('039', growth1, growth2, growth3, Probability, keys, t, rep=100)
...
plotImportance('039', keys, importance)

X_part = X[['001000.0', '020602.0']]
rf = RandomForestClassifier(n_estimators=100, max_depth=4, random_state=2021)
rf.fit(X_part, y)
rf.score(X_part, y)
rf.predict([(p39_1, p39_3)])
...
X_part = X[['010801.0', '020602.0']]
rf = RandomForestClassifier(n_estimators=100, max_depth=4, random_state=2021)
rf.fit(X_part, y)
rf.score(X_part, y)

rf.predict([(p39_2, p39_3)])
