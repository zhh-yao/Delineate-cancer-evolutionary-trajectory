...
plotImportance('058', keys, importance)

X_part = X[['001000.0', '030403.0']]
rf = RandomForestClassifier(n_estimators=100, max_depth=4, random_state=2021)
rf.fit(X_part, y)
rf.score(X_part, y)

rf.predict([(p58_1, p58_2)])
rf.predict([(p89_1, p89_2)])
rf.predict([(p126_1, p126_2)])
...
X_part = X[['001000.0', '030403.0', '040204.0']]
rf = RandomForestClassifier(n_estimators=100, max_depth=4, random_state=2021)
rf.fit(X_part, y)
rf.score(X_part, y)

rf.predict([(p58_1, p58_2, p58_3)])
rf.predict([(p89_1, p89_2, p89_3)])
rf.predict([(p126_1, p126_2, p126_3)])
